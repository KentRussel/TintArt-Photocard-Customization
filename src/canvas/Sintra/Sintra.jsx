...
const Sintra = () => {
  ...
  const { nodes, materials } = useGLTF('/sintra.glb');

  const modelNode = nodes.Cube_Material_0; // Use the specific node name obtained from the Three.js Editor
  const modelMaterial = materials.Material; // Use the specific material name obtained from the Three.js Editor
